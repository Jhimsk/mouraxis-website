function Hero() {
  return (
    <section className="bg-[#F5F3EE]">
      <div className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-7xl items-center gap-14 px-6 py-20 lg:grid-cols-2 lg:px-8">
        ...
        <div>
          ...
          <h1 className="max-w-3xl text-5xl font-semibold leading-[1.02] tracking-tight text-[#081C2C] md:text-7xl">
            Engineering Reality.
            <br />
          ...
          <div className="mt-9 flex flex-wrap gap-4">
            <a
              href="#contact"
              className="rounded-md bg-[#081C2C] px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-[#123B5D]"
            >
              Start a Project
            </a>
        ...
        {/* RIGHT — DIGITAL INTELLIGENCE PANEL */}
        <div className="relative">
          <div className="overflow-hidden rounded-3xl border border-slate-200 bg-[#0B1F33] p-5 shadow-2xl shadow-slate-900/15">
            ...
            {/* visualization */}
            <div className="relative min-h-[430px] overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-[#112D46] to-[#071521]">
              ...
              {/* control points */}
              <div className="absolute left-[28%] top-[35%] h-3 w-3 rounded-full bg-[#2F80ED] shadow-[0_0_20px_rgba(47,128,237,0.8)]" />
              <div className="absolute right-[27%] top-[48%] h-3 w-3 rounded-full bg-[#2F80ED] shadow-[0_0_20px_rgba(47,128,237,0.8)]" />
              <div className="absolute bottom-[24%] left-[44%] h-3 w-3 rounded-full bg-[#2F80ED] shadow-[0_0_20px_rgba(47,128,237,0.8)]" />
            ...
            <div className="grid grid-cols-3 gap-3 pt-4 text-center">
              <div className="rounded-xl border border-white/10 bg-white/[0.04] px-3 py-4">
                ...
                <p className="mt-1 text-xs text-slate-400">Control Points</p>
              </div>

              <div className="rounded-xl border border-white/10 bg-white/[0.04] px-3 py-4">
                <p className="text-xl font-semibold text-white">±0.03'</p>
                <p className="mt-1 text-xs text-slate-400">Tolerance</p>
              </div>
